...
# Nueva importación para combinación maestra
from modules.utils.combinador_maestro import generar_combinacion_maestra
...
class HybridOmegaPredictor:
    ...
    def run_all_models(self) -> List[Dict[str, Any]]:
        ...
        # Nueva integración: Generar combinación maestra
        try:
            ...
            # Opcional: Puedes agregar la maestra a final si lo deseas
            # final.append({"combination": metadata_maestra["combinacion_maestra"], "source": "maestra", "score": metadata_maestra["score"]})
        except Exception as e:
